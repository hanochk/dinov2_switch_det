...
python -u main.py --epoch 50 --batch-size 64 --output-folder /mnt/Data/hanoch/runs/dinov2_classifier --lr 0.0005 --linear-lr --global-crops-size 518 --dropout 0.2 --var-hidden-dim
